...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.canvas = customtkinter.CTkCanvas(master=self.frame_info,width=App.WIDTH-100, height=App.HEIGHT-200,bd=0, highlightthickness=0,bg="#222222")
        ...
        self.scrollbar = customtkinter.CTkScrollbar(master=self.frame_right, command=self.canvas.yview,width=20,height=App.HEIGHT-200)
